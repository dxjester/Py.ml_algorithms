...
train = train.fillna(train.mean()) # use the mean of the values
test = test.fillna(test.mean())

# create a list of the column names
features = list(train.columns)

# develop the model with 100 trees
...
# train predictions in order to identify overfitting
train_rf_predictions = model.predict(train)
train_rf_probs = model.predict_proba(train)[:, 1]

# test predictions in order to determine performance
